...
#define DATA_FRAME_LENGTH (FRAME_HEADER_LENGTH + CMD_ID_LENGTH + FRAME_TAIL_LENGTH)
...
enum Enum_Referee_Command_ID : uint16_t
{
	...
	Referee_Command_ID_ROBOT_GROUND_ROBOT_POS,
 ...
 *
 */
enum Enum_Referee_Data_Robots_ID : uint16_t
{
...
struct Struct_Interaction_Figure
{ 
 ...
 *
 */
struct Struct_Referee_Rx_UART_Data
{
    Struct_Frame_Head_ID Frame_Head_ID;
    uint8_t Data[121];
} __attribute__((packed));
 ...
 *
 */
struct Struct_Referee_Tx_UART_Data
{
    Struct_Frame_Head_ID Frame_Head_ID;
    uint8_t Data[121];
} __attribute__((packed));
...
struct Struct_Referee_Tx_Data_Interaction_Graphic_1
{
    ...
    Enum_Referee_Data_Robots_ID Sender;
    Enum_Referee_Data_Robots_Client_ID Receiver;
    Struct_Interaction_Figure Graphic_1;
    uint16_t CRC_16;
} __attribute__((packed));
...
struct Struct_Referee_Tx_Data_Interaction_Graphic_2
{
    ...
    Enum_Referee_Data_Robots_Client_ID Receiver;
    Struct_Interaction_Figure Graphic_1;
    Struct_Interaction_Figure Graphic_2;
    uint16_t CRC_16;
} __attribute__((packed));
...
struct Struct_Referee_Tx_Data_Interaction_Graphic_5
{
    ...
    Struct_Interaction_Figure Graphic_1;
    Struct_Interaction_Figure Graphic_2;
    Struct_Interaction_Figure Graphic_3;
    Struct_Interaction_Figure Graphic_4;
    Struct_Interaction_Figure Graphic_5;
    uint16_t CRC_16;
} __attribute__((packed));
...
struct Struct_Referee_Tx_Data_Interaction_Graphic_7
{
    ...
    Struct_Interaction_Figure Graphic_4;
    Struct_Interaction_Figure Graphic_5;
    Struct_Interaction_Figure Graphic_6;
    Struct_Interaction_Figure Graphic_7;
    uint16_t CRC_16;
} __attribute__((packed));
...
struct Struct_Referee_Tx_Data_Interaction_Graphic_String
{
    ...
    Enum_Referee_Data_Robots_ID Sender;
    Enum_Referee_Data_Robots_Client_ID Receiver;
    Struct_Interaction_Figure Graphic_String;
    uint8_t String[30];
    uint16_t CRC_16;
} __attribute__((packed));
...
public:
	...
	void UI_Draw_Line(Struct_Interaction_Figure *Graph,char GraphName[3],uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t Width,uint16_t StartX,uint16_t StartY,uint16_t EndX,uint16_t EndY);         
	void UI_Draw_Rectangle(Struct_Interaction_Figure *Graph,char GraphName[3],uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t Width,uint16_t StartX,uint16_t StartY,uint16_t EndX,uint16_t EndY);        
	void UI_Draw_Circle(Struct_Interaction_Figure *Graph,char GraphName[3],uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t Width,uint16_t CenterX,uint16_t CenterY,uint16_t Radius);       
	void UI_Draw_Ellipse(Struct_Interaction_Figure *Graph,char GraphName[3],uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t Width,uint16_t CenterX,uint16_t CenterY,uint16_t XHalfAxis,uint16_t YHalfAxis);    
	void UI_Draw_Arc(Struct_Interaction_Figure *Graph,char GraphName[3],uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t StartAngle,uint16_t EndAngle,uint16_t Width,uint16_t CenterX,uint16_t CenterY,uint16_t XHalfAxis,uint16_t YHalfAxis);   
	void UI_Draw_Float(Struct_Interaction_Figure *Graph,char GraphName[3], uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t NumberSize,uint16_t Significant,uint16_t Width,uint16_t StartX,uint16_t StartY,float FloatData);    
	void UI_Draw_Int(Struct_Interaction_Figure *Graph,char GraphName[3],uint8_t GraphOperate,uint8_t Layer,uint8_t Color,uint16_t NumberSize,uint16_t Width,uint16_t StartX,uint16_t StartY,int32_t IntData);     
	void UI_Draw_String(Struct_Referee_Tx_Data_Interaction_Graphic_String *String,char StringName[3],uint8_t StringOperate,uint8_t Layer,uint8_t Color,uint16_t CharSize,uint16_t StringLength,uint16_t Width,uint16_t StartX,uint16_t StartY,char *StringData);

	void Data_Concatenation(Enum_Referee_Command_ID __Referee_Command_ID,uint8_t *__Data, uint16_t __Data_length);
	//图形删除交互信息
...
protected:
	...
	//发送源数据
	Struct_Referee_Tx_UART_Data Referee_Tx_UART_Data;

    //读写变量

    //内部函数

    uint8_t Get_CRC_8(uint8_t *Message, uint32_t Length);
    uint16_t Get_CRC_16(uint8_t *Message, uint32_t Length);
    void Data_Process();
...
Enum_Referee_Data_Status Class_Referee::Get_Event_Supply_Status(uint8_t Supply_ID)
{
    switch (Supply_ID)
    {
		...
		default:
		{
			return (static_cast<Enum_Referee_Data_Status>(0));
		}
		break;
    }
}
