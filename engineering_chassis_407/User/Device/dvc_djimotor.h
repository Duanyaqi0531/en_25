...
void Class_DJI_Motor_GM6020::Set_Target_Omega_Rpm(int16_t __Target_Omega_Rpm)
{
    Target_Omega_Rpm = __Target_Omega_Rpm;
}
...
void Class_DJI_Motor_C610::Set_Target_Omega_Rpm(int16_t __Target_Omega_Rpm)
{
    Target_Omega_Rpm = __Target_Omega_Rpm;
}
